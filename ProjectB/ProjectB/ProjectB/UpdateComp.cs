...
namespace ProjectB
{
    public partial class UpdateComp : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            } //for showing RubricId in combobox
            SqlCommand cmd2;
            ...
            //for showing Assessmentid in combobox 
            con.Close();
        }
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            //for redirecting the page to Assessment portal //
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            // for redirecting it to component assessment reading //
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == ConnectionState.Open)
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("AssessComponent has updated successfully"); //updated assessment component
            }
